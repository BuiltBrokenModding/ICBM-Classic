...
public class FlyingBlock {
     ...
     */
    public static boolean spawnFlyingBlock(Level level, BlockPos pos, BlockState state) {
     ...
     */
    public static boolean spawnFlyingBlock(Level level, BlockPos pos, BlockState state,
                                           Consumer<FlyingBlockEntity> preSpawnCallback,
                                           Consumer<FlyingBlockEntity> postSpawnCallback) {
        if (!isAllowed(state)) {
            return false;
        }
        ...
        final FlyingBlockEntity flyingBlock = new FlyingBlockEntity(world);
