...
import icbm.classic.world.block.launcher.cruise.gui.LaunchButton;
...
public class GuiEMPTower extends GuiContainerBase {
    ...
    public static final Component TRANSLATION_TOOLTIP_RANGE = new TextComponentTranslation(LANG_KEY + ".range");

    // Texture
    public static final ResourceLocation TEXTURE = new ResourceLocation(IcbmConstants.MOD_ID, IcbmConstants.GUI_DIRECTORY + "gui_emp_tower.png");

    private final EmpTowerBlockEntity tileEntity;

    public GuiEMPTower(Player player, EmpTowerBlockEntity tileEntity) {
    ...
    public void initGui() {
        ...
        addComponent(TextInput.intField(componentID++, fontRenderer, 18, 17, 40, 12,
            tileEntity::getRange, tileEntity::setRange, (r) -> EmpTowerBlockEntity.PACKET_RADIUS.sendToServer(tileEntity)));

        // Frequency field
        addComponent(TextInput.textField(componentID++, fontRenderer, 135, 17, 34, 12,
            tileEntity.radioCap::getChannel, tileEntity.radioCap::setChannel, (r) -> EmpTowerBlockEntity.PACKET_RADIO_HZ.sendToServer(tileEntity)));
        ...
        addButton(new LaunchButton(0, guiLeft + 24, guiTop + 38)
            ...
            .setAction(() -> EmpTowerBlockEntity.PACKET_FIRE.sendToServer(tileEntity))
        ...
        addComponent(new DisableButton(1, guiLeft + 119, guiTop + 16, tileEntity.radioCap::isDisabled)
            .setAction(() -> EmpTowerBlockEntity.PACKET_RADIO_DISABLE.sendToServer(tileEntity))
        );
