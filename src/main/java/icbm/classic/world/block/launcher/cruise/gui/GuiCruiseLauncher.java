...
public class GuiCruiseLauncher extends GuiContainerBase {
    ...
    // Texture
    public static final ResourceLocation TEXTURE = new ResourceLocation(IcbmConstants.MOD_ID, IcbmConstants.GUI_DIRECTORY + "gui_cruise_launcher.png");

    // Launcher
    private final TileCruiseLauncher tileEntity;

    public GuiCruiseLauncher(Player player, TileCruiseLauncher tileEntity) {
