...
public class GuiLauncherScreen extends GuiContainerBase {
    public static final ResourceLocation TEXTURE = new ResourceLocation(IcbmConstants.MOD_ID, IcbmConstants.GUI_DIRECTORY + "gui_silo_screen.png");
    public static final Component ACCURACY_TOOLTIP = new TextComponentTranslation("gui.launcherscreen.inaccuracy.info");

    private final TileLauncherScreen tileEntity;

    public GuiLauncherScreen(Player player, TileLauncherScreen tileEntity) {
