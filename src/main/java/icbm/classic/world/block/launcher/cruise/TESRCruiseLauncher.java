 ...
 */
public class TESRCruiseLauncher extends BlockEntitySpecialRenderer<TileCruiseLauncher> {
    public static final ResourceLocation TEXTURE_FILE = new ResourceLocation(IcbmConstants.MOD_ID, "textures/models/cruise_launcher_top.png");
