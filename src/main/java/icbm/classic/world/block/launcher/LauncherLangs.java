...
public final class LauncherLangs {
    ...
    public static final Component TRANSLATION_READY = new TextComponentTranslation(LauncherLangs.STATUS_READY);
    public static final Component TRANSLATION_ERROR_NO_NETWORK = new TextComponentTranslation(LauncherLangs.ERROR_NO_NETWORK);
    public static final Component TRANSLATION_ERROR_NO_LAUNCHER = new TextComponentTranslation(LauncherLangs.ERROR_NO_LAUNCHER);
    public static final Component TRANSLATION_ERROR_NO_NETWORK_STATUS = new TextComponentTranslation(LauncherLangs.ERROR_NO_NETWORK_STATUS);

    public static final Component TRANSLATION_TOOLTIP_RADIO = new TextComponentTranslation("gui.icbmclassic:tooltip.radio.channel");
    public static final Component TRANSLATION_TOOLTIP_TARGET = new TextComponentTranslation("gui.icbmclassic:tooltip.target");
}
