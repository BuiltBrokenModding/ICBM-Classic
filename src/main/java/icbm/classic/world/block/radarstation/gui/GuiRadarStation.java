...
public class GuiRadarStation extends GuiContainerBase {
    public static final ResourceLocation TEXTURE = new ResourceLocation(IcbmConstants.MOD_ID, IcbmConstants.GUI_DIRECTORY + "gui_radar.png");

    private final TileRadarStation tileEntity;

    public GuiRadarStation(Player player, TileRadarStation tileEntity) {
