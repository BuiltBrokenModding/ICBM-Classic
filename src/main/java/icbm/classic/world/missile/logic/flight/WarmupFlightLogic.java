...
import icbm.classic.world.missile.logic.flight.prefab.FlightLogic;
...
public class WarmupFlightLogic extends FlightLogic {
    ...
    public static final ResourceLocation REG_NAME = new ResourceLocation(IcbmConstants.MOD_ID, "engine.warmup");
