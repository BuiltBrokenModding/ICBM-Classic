...
public class DirectFlightLogic extends DeadFlightLogic {
    public static final ResourceLocation REG_NAME = new ResourceLocation(IcbmConstants.MOD_ID, "direct");
    ...
    @Override
    public void calculateFlightPath(Level level, double startX, double startY, double startZ, IMissileTarget targetData) {
