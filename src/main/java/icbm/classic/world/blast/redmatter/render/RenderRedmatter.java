...
@OnlyIn(Dist.CLIENT)
public class RenderRedmatter extends Render<RedmatterEntity> {
    public static final ResourceLocation TEXTURE_FILE = new ResourceLocation(IcbmConstants.MOD_ID, IcbmConstants.TEXTURE_DIRECTORY + "entity/redmatter/blackhole.png");
    ...
    @Override
    public void doRender(RedmatterEntity redmatter, double x, double y, double z, float entityYaw, float partialTicks) {
    ...
    public void renderSphere(RedmatterEntity redmatter, double x, double y, double z, float visualSize) {
    ...
    public void renderDisk(RedmatterEntity redmatter, double x, double y, double z, float visualSize) {
    ...
    public void renderBeams(RedmatterEntity redmatter, double x, double y, double z, float visualSize) {
    ...
    @Nullable
    @Override
    protected ResourceLocation getEntityTexture(RedmatterEntity entity) {
        return GREY_TEXTURE;
    }
}
