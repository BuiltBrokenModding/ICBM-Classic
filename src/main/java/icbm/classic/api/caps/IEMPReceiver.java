...
/**
 * Applied to an object as a capability (Item/Entity/BlockEntity)
...
public interface IEMPReceiver {
     ...
     *
     * @param level     - this object's world
     ...
     */
    default float applyEmpAction(Level level, double x, double y, double z, IBlast emp_blast, float power, boolean doAction) {
        //At the moment power is not used, check back later - 3/12/2018 Dark

        //Do something to your object
        //  Ex: Item -> Drain power
        //  Ex: EntityCreeper -> Super charge
        //  Ex: BlockEntity -> Turn off machine or explode
    ...
    /**
     * Sub version of {@link #applyEmpAction(Level, double, double, double, IBlast, float, boolean)} used in
     ...
     * Ex: {@link net.minecraft.entity.player.Player},
     * {@link net.minecraft.tileentity.BlockEntityChest},
     * {@link net.minecraft.entity.item.EntityMinecartChest}
     *
     * @param container - object containing this sub-object
     */
    default float applyEmpAction(Level level, double x, double y, double z, IBlast emp_blast, Object container, float power, boolean doAction) {
        return applyEmpAction(level, x, y, z, emp_blast, power, doAction);
    }
     ...
     */
    default float getEmpResistance(Level level, double x, double y, double z, float power) {
        return 0;
    }
     ...
     */
    default boolean isEmpResistanceFlat(Level level, double x, double y, double z, float power) {
        return true;
    }
     ...
     */
    default boolean shouldEmpSubObjects(Level level, double x, double y, double z) {
        return true;
    }
}
