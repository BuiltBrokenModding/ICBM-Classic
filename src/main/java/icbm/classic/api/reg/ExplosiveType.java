 ...
 */
public interface ExplosiveType {

    IBlastFactory EMPTY = () -> null;
    ...
    default IBlastInit create() {
        return Optional.ofNullable(getBlastFactory()).orElse(EMPTY).create();
    }
     ...
     *
     * @param location - id of the registry
     * @param registry - the registry itself
     * @return true to allow, false to block
     */
    boolean onEnableContent(ResourceLocation location, IExplosiveContentRegistry registry);
}
