...
public class BlockEditHandler {
    ...
    public static void onWorldUnload(WorldEvent.Unload event) {
        final int dim = event.getLevel().provider.getDimension();
    ...
    public static void queue(Level level, Collection<BlockPos> edits, Consumer<BlockPos> onEditBlock) {
        queue(world, edits, onEditBlock, null);
    }

    public static void queue(Level level, Collection<BlockPos> edits, Consumer<BlockPos> onEditBlock, Runnable onCompleteCallback) {
