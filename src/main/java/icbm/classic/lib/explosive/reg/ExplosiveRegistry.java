...
public class ExplosiveRegistry implements IExplosiveRegistry {
    ...
    public final HashMap<ResourceLocation, ExplosiveType> explosiveData = new HashMap();
    ...
    private ImmutableSet<ExplosiveType> allExplosives;

    @Override
    public ExplosiveType register(ResourceLocation name, WeaponTier tier, IBlastFactory blastFactory) {
        if (locked) {
        ...
        //Store factory
        explosiveData.put(name, new SimpleExplosiveType(tier, blastFactory));
    ...
    @Override
    public ExplosiveType getExplosiveData(ResourceLocation name) {
        return explosiveData.get(name);
    }

    @Override
    public ExplosiveType getExplosiveData(int id) {
    ...
    @Override
    public Set<ExplosiveType> getExplosives() {
