...
public abstract class CapabilityEmpInventory<H extends Object> implements IEMPReceiver
{
    ...
    public static class EntityInv extends CapabilityEmpInventory<Entity>
    {
        ...
        {
            if (ConfigBlast.emp.ALLOW_ENTITY_INVENTORY && entity.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY, null).isPresent())
            {
    ...
    public static class TileInv extends CapabilityEmpInventory<TileEntity>
    {
        ...
        protected IItemHandlerModifiable getCapability()
        {
            if (ConfigBlast.emp.ALLOW_TILE_INVENTORY && entity.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY, null).isPresent())
            {
                IItemHandler handler = entity.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY, null).orElseThrow(IllegalStateException::new);
    ...
    public static class ItemInvInEntity extends CapabilityEmpInventory<Entity>
    {
        ...
        protected IItemHandlerModifiable getCapability()
        {
            if (ConfigBlast.emp.ALLOW_ITEM_INVENTORY && item.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY, null).isPresent())
            {
