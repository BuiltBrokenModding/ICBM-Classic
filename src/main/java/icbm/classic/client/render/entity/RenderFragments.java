...
@OnlyIn(Dist.CLIENT)
public class RenderFragments extends EntityRenderer<EntityExplosiveFragment>
{
    ...
    @Override
    public void doRender(EntityExplosiveFragment entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
    ...
    @Nullable
    @Override
    protected ResourceLocation getEntityTexture(EntityExplosiveFragment entity)
    {
        return TEXTURE;
    }
}
