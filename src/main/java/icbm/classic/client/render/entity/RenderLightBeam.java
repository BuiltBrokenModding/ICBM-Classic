...
import icbm.classic.world.entity.LightBeamEntity;
...
@OnlyIn(Dist.CLIENT)
public class RenderLightBeam extends Render<LightBeamEntity> {
    ...
    @Override
    public void doRender(LightBeamEntity beamEntity, double x, double y, double z, float entityYaw, float partialTicks) {
        GlStateManager.alphaFunc(516, 0.1F);
        this.bindTexture(TEXTURE_BEACON_BEAM);

        GlStateManager.disableFog();

        int height = 255 - (int) beamEntity.getY();
    ...
    @Override
    protected ResourceLocation getEntityTexture(LightBeamEntity entity) {
