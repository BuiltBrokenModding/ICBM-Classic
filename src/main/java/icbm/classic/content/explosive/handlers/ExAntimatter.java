...
public class ExAntimatter extends Explosion
{
    ...
    {
        new BlastAntimatter(world, entity, pos.getX() + 0.5f, pos.getY() + 0.5f, pos.getZ() + 0.5f, ConfigBlast.ANTIMATTER_SIZE * scale, ConfigBlast.ANTIMATTER_DESTROY_UNBREAKABLE_BLOCKS).runBlast();
    }
}
