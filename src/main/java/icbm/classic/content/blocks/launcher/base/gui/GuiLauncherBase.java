...
public class GuiLauncherBase extends GuiContainerBase
{
    ...
    public GuiLauncherBase(ContainerLaunchBase container, PlayerEntity player, TileLauncherBase tileEntity)
    {
        super(container, player.inventory, new TranslationTextComponent("gui.icbmclassic:launcherbase.title"));
    ...
    {
        this.font.drawString("\u00a77" + LanguageUtility.getLocal("gui.icbmclassic:launcherbase.name"), 30, 6, 4210752);
