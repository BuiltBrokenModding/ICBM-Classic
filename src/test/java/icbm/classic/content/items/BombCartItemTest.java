...
import icbm.classic.world.item.BombCartItem;
...
@TestWithResources
public class BombCartItemTest extends TestBase {
    ...
    public static void beforeAllTests()
    {
        ...
        ForgeRegistries.ITEMS.register(item = new BombCartItem().setName("bombcart").setCreativeTab(ICBMClassic.CREATIVE_TAB));
    }
    ...
    void loadFromVersion4() {
        ...
        assertExplosive(stack, "icbmclassic:sonic", new CompoundTag());
    }
}
